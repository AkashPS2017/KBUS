...
public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.MyViewHolder> {
    ...
    List<Matcheslistoffline> matcheslists;
    ...
    public RecyclerviewAdapter(Context context, List<Matcheslistoffline> bus,RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Matcheslistoffline list = matcheslists.get(position);
